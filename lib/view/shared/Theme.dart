...
ThemeData theme() {
  return ThemeData(
      ...
      textTheme: TextTheme(
        headline1: TextStyle(
            fontSize: Dimens.size_heading1,
            fontWeight: FontWeight.normal,
            color: textcolor),
        headline2: TextStyle(
            fontSize: Dimens.size_heading2,
            fontWeight: FontWeight.normal,
            color: textcolor),
        headline3: TextStyle(
            fontSize: Dimens.size_heading3,
            fontWeight: FontWeight.normal,
            color: textcolor),
        headline4: TextStyle(
            fontSize: Dimens.size_heading4,
            fontWeight: FontWeight.normal,
            color: textcolor),
        bodyText1: TextStyle(
            fontSize: Dimens.size_body,
            fontWeight: FontWeight.normal,
            color: textcolor),
      ),
      ...
      chipTheme: ChipThemeData(
          ...
          secondarySelectedColor: Colors.red.shade600,
